...
class Gameover (Popup):
    ...
    def __init__(self):
        super().__init__()
        self.ids.textox.text="Thanks for your Participation!"
...
class Janela(BoxLayout):
    ...
    def load(self):
        ...
        try:
            os.stat(self.nome+"-response")
        except:
            os.mkdir(self.nome+"-response")
    ...
    def gravar(self):
        self.WAVE_OUTPUT_FILENAME=self.nome+"-response/"+self.files[self.i]+"_"+self.nome+".wav"
